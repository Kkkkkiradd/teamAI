...
import com.example.dao.{FileInfoDao, HdfsDao, HeaderInfoDao}
import com.example.entity.{FileInfo, HeaderInfo}
...
class CsvAdapter extends SparkConnect{
  ...
  /**
    ...
    */
  @throws(classOf[Exception])
  def Csv2Parquet(inFile: String, outFile: String, userId: Int): Int = {
